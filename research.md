...
- Cleavage map and the focal issues: the attitudinal divisions in cyberspace on re-distributive social welfare. Working paper.
    <details>
      <summary>Abstract</summary>
    Disagreement among the population regarding redistributive issues is highly visible in cyberspace, where people debate the necessity, legitimacy, and feasibility of social security, tax cuts, strikes, and other related topics. Under the pressures of surging living costs, the long-tail Brexit influence, and the tough recovery from an unprecedented pandemic, we are witnessing a much more divided public sphere on social and political issues in the UK and across the world. This study examines debates on public forums and investigate the presentation and variation of online attitudinal divisions related to redistributive social issues such as council tax, universal income, and minimum wage. We collected analytical data from Reddit, focusing on debates within the UKPolitics subreddit after 2022. We use fine-tuned BERTopic models for topic discovery, sentiment analysis was conducted using BERT trained on the GOEMOTIONS dataset, and LLMs are used to summarise the stance and the attribution shown in the comments. The initial analysis revealed key thematic patterns and variations in public attitudes toward the selected re-distributional issues. Sentiment trends also responded swiftly to major social and political events at the time, such as the mini-budget, increases in council tax, changes to the minimum wage, and national insurance policies. The discussions clusters revealed distinct divisional dimensions commonly found in social policy literature—namely, self-interest, fairness and deservingness, moral judgement, and the role of government. The attribution identification echoes the output of topic models, reveal complex structure of the way people attribute the key social issues to. For instance, the problems around council tax/income tax are attributed to political design flaws, fiscal constraints and irresponsible political commitments, as well as income inequalities; minimum wage related discussions attribute the problem to short-/long-term wage erosion, political opportunism, and employer mal-practices and low-wage business models. Our work also highlights the conversational structure of online debates, showing how stances shift and what rationales individuals rely on in forming their arguments against each other. This project offers an initial exploration of how attitudinal social cleavages manifest in cyberspace in response to re-distributional issues with distinct characteristics and political agendas.
    </details>  
...
- On the selection of covariates for transportability: A Doubly Robust BART approach for generalizing a food labeling trial and modeling long-term public health impact. Working paper.
    <details>
      <summary>Abstract</summary>
