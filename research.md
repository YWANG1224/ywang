...
- Ting LUO, **Yan WANG**. 2025. The art of storytelling: Pro-regime narratives on Chinese social media and the official opinion leaders. Under Review. <a href="https://doi.org/10.48550/arXiv.2512.11875">Available here</a> 
    <details>
      <summary>Abstract</summary>
...
- Cleavage map and the focal issues: the attitudinal divisions in cyberspace on re-distributive social welfare. Working paper.
    <details>
      <summary>Abstract</summary>
    Disagreement among the population regarding redistributive issues is highly visible in cyberspace, where people debate the necessity, legitimacy, and feasibility of social security, tax cuts, strikes, and other related topics. This study examines debates on public forums and investigates the presentation and variation of online attitudinal divisions related to redistributive social issues such as council tax, universal income, and minimum wage. We collected analytical data from Reddit, focusing on debates within the UKPolitics subreddit after 2022. We used fine-tuned BERTopic models for topic discovery, conducted sentiment analysis using BERT trained on the GOEMOTIONS dataset, and applied large language models (LLMs) to summarise the stances and attributions found in the comments. The initial analysis revealed key thematic patterns and variations in public attitudes toward the selected redistributional issues. Sentiment trends also responded swiftly to major social and political events at the time, such as the mini-budget, increases in council tax, changes to the minimum wage, and national insurance policies. The discussion clusters revealed distinct divisional dimensions commonly found in social policy literature—namely, self-interest, fairness and deservingness, moral judgement, and the role of government. Attribution analysis echoed the output of topic models, revealing the complex structure through which people assign responsibility for key social issues. For instance, problems surrounding council tax and income tax were attributed to political design flaws, fiscal constraints, irresponsible political commitments, and income inequality. Discussions related to the minimum wage attributed the issue to short- and long-term wage erosion, political opportunism, employer malpractices, and low-wage business models. Our work also highlights the conversational structure of online debates, showing how stances shift and what rationales individuals rely on when forming arguments against one another. This project offers an initial exploration of how attitudinal social cleavages manifest in cyberspace in response to redistributional issues with distinct characteristics and political agendas.
    </details>  

- A Tale of Two Discourses: Social Media Discussion on Pension Reforms in China. Working paper.
    <details>
      <summary>Abstract</summary>
    As one of the most important areas of redistributive policy, pension reforms have long been at the center of political agendas and public debate—especially those that are potentially controversial. China’s public pension reforms over the past 20 years have been characterized by incremental adjustments—such as expanding and centralizing the pooling of pension funds and gradually raising the retirement age—rather than one-off, clear-cut reforms. These incremental features of pension reform are reflected not only in policy details, but also in the process of policy decision-making. As a typical case, the retirement age adjustments announced in late 2024 have drawn significant public attention since the idea was first proposed during the Third Plenary Session of the 18th Central Committee of the CCP in 2013. The more than ten-year process leading up to the final announcement prompted widespread speculation about the policy’s possible scope, implementation stages, and eventual materialization. Departing from conventional institutional and economic perspectives on the contentious dimensions of pension reform, this paper follows ideational and discursive institutionalist approaches (Béland, 2010; Schmidt, 2011; Carstensen & Schmidt, 2016) to unpack the controversy from the standpoint of political discourse and public opinion. Specifically, we take the example of China’s retirement age adjustments and examine how reform-related issues are discussed on social media platforms by both verified institutional and individual users, in order to assess whether and how state and citizen discourses differ. We conduct multi-step computational text analyses of a unique dataset of 184,667 social media posts by different verified users published between 2013 and 2024 that reference retirement age policy reform. Drawing on framing theory by Entman (1993), we categorize posts into macro (diagnostic) and micro (prognostic) issues using relevant keyword sets. Across our empirical analyses, we find that macro-issue convergence coexists with micro-issue divergence. Specifically, convergence in state and citizen discourses around macro issues reflects a shared recognition of broad societal challenges (e.g., population aging and pension system pressures), which may provide common ground for reform. In contrast, divergence in micro issues reveals tensions over agency, responsibility, and the distribution of burdens. In other words, the two groups diverge in what they expect from the public pension system for individuals facing the social risks of aging. While institutional accounts representing state discourse emphasize risk pooling and technocratic–economic frames, individual accounts tend to care more about personal choice and distributive justice, reflecting a humanistic–social frame. This divergence in framing and embedded prognostic rationales between the state and society undermines the potential for bold and decisive reform to address rapidly changing demographic aging and pension system pressures, due to the lack of a shared cognitive foundation. Our work contributes to the literature on discourse and framing conflicts in pension reform by highlighting state–society divergence in prognostic judgments of redistributive policies. Even in non-electoral regimes like China, where conventional theories might expect deterministic reforms, such ideational divergence between the state and society not only adds to the controversy surrounding pension reforms but also complicates the policy change process.
    </details>  

      
- On the selection of covariates for transportability: A doubly robust machine learning approach for generalizing a food labelling trial with mixed-type. Working paper.
    <details>
      <summary>Abstract</summary>
    While randomized controlled trials are considered the benchmark for assessing treatment effects, their findings often lack external validity to broader populations. To address this, transportability methods aim to enhance generalizability; however, their reliability is contingent on the appropriate selection of statistical estimators and covariates for adjustment. This paper tackles these challenges through a two-pronged approach. First, it provides a policy-relevant estimate by transporting the effects of various front-of-package nutritional labels on food choices from an RCT to the National Diet and Nutrition Survey. Second, it conducts a methodological investigation into the bias-variance trade-off associated with covariate selection, comparing adjustment sets derived from standard demographics with those based on a robust, theoretically grounded, continuous effect modifier. Our analytical framework incorporates a range of estimators, including parametric models and flexible, non-parametric Bayesian Additive Regression Trees within both singly- and doubly-robust methodologies. Our findings underscore the critical importance of both estimator choice and covariate selection. Specifically, the bayesian doubly robust estimator, identified as our most dependable model, revealed that both coarse and detailed labels were associated with a modest but statistically significant increase in the calorie content of selected products compared to a no-label control—a discovery entirely obscured by less sophisticated or singly-robust approaches. This study thus offers a cautionary, population-level assessment of a key public health intervention and practically illustrates the principles of transportability.
    </details>  
...
- The evil state or the abandoned generation? The dynamic cleavage of cyber debates around China's retirement age policy 
