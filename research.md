...
- Cleavage map and the focal issues: the attitudinal divisions in cyberspace on re-distributive social welfare. Working paper.
    <details>
      <summary>Abstract</summary>
    Disagreement among the population regarding redistributive issues is highly visible in cyberspace, where people debate the necessity, legitimacy, and feasibility of social security, tax cuts, strikes, and other related topics. This study examines debates on public forums, combining state-of-the-art machine learning techniques to investigate the presentation and variation of online attitudinal divisions related to redistributive social issues such as council tax, universal income, and minimum wage. We collected analytical data from Reddit, focusing on debates within the UKPolitics subreddit after 2020. Fine-tuned BERTopic models were applied for topic discovery; sentiment analysis was conducted using BERT trained on the GOEMOTIONS dataset; and narrative structure analysis was carried out using the RELATIO package to extract key narratives from the conversations. This initial analysis revealed key thematic patterns and variations in public attitudes toward the selected redistributional issues. Sentiment trends also responded swiftly to major social and political events at the time, such as the mini-budget, increases in council tax, changes to the minimum wage, and national insurance policies. These discussions further revealed distinct framing dimensions commonly found in social policy literature—namely, self-interest, fairness, deservingness, and the role of government. Our work also highlights the conversational structure of online debates, showing how stances shift and what rationales individuals rely on in forming their arguments. This project offers an initial exploration of how attitudinal social cleavages manifest in cyberspace in response to redistributional issues with distinct characteristics and political agendas.
    </details>  
